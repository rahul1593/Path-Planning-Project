...
double ref_v = 0.0; // current velocity of vehicle
double ref_a = 0.224; // acceleration value
double max_v = 49.5;    //maximum velocity

//set the lane to which vehicle must move
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          // j[1] is the data JSON object
            ...
            double check_speed;
            //check if a vehicle in current lane is too close
