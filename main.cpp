        ...
        if (event == "telemetry") {
          // j[1] is the data JSON object
            ...
            if(too_close){
                cout<< "Too Close\n";
                ref_v -= 0.224;
                //get cost for the three lanes
                vector<double> cost(3);    // cost for left, keep and right
                double mc = 999999.9;
                double clane = lane;
                // get minimum cost for three manuevers, change lane left, change_lane right, move straight with reduced speed
            ...
            if(prev_size < 2){
                // use two points that make the path tangemt to the car
            ...
            // In ferenet add evenly 30m spaced points of the starting reference
